...
async function departamento(request, response){
	...
	try {
		...
		stmt.input('strdepartamento', mssql.VarChar(100), strdepartamento)
		...
		await stmt.execute('geografica.sp_departamento', function (err, result){
			if (err){
