...
async function region(request, response){
	...
	try {
		...
		stmt.input('codregion', mssql.Int, codregion)
		stmt.input('strregion', mssql.VarChar(100), strregion)
		...
		await stmt.execute('geografica.sp_region', function (err, result){
			if (err){
